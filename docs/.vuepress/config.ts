...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    author: {
      name: "Clifforid", // 必需
      link: "https://github.com/Clifforid", // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'Cliff Zhang | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
  ...
  head: [
    ["link", { rel: "icon", href: "/img/爱宠27.png" }], //favicons，资源放在public文件夹
    [
      "meta",
      {
        name: "keywords",
  ...
  plugins: <UserPlugins>[
    ...
    //       owner: "Clifforid", // GitHub仓库所有者
    //       admin: ["Clifforid"], // 对仓库有写权限的人
